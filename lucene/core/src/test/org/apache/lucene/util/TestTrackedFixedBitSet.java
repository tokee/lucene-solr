...
public class TestTrackedFixedBitSet extends BaseBitSetTestCase<TrackedFixedBitSet> {

  @Override
  public TrackedFixedBitSet copyOf(org.apache.lucene.util.BitSet bs, int length) throws IOException {
...
//    }
  ...
  public void testTrackedPrevSetBitA() throws IOException {
    TrackedFixedBitSet bitset = new TrackedFixedBitSet(100000);
    bitset.set(7);
    bitset.set(87);
    bitset.set(640);
    bitset.set(7001);
