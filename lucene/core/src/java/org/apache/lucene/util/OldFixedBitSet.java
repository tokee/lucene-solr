 ...
 * @lucene.internal
 */
public final class OldFixedBitSet extends BitSet implements MutableBits, Accountable {

  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(OldFixedBitSet.class);
  ...
  /**
   * If the given {@link OldFixedBitSet} is large enough to hold {@code numBits+1},
   * returns the given bits, otherwise returns a new {@link OldFixedBitSet} which
   ...
   */
  public static OldFixedBitSet ensureCapacity(OldFixedBitSet bits, int numBits) {
    if (numBits < bits.numBits) {
      ...
      return new OldFixedBitSet(arr, arr.length << 6);
    }
  }
   ...
   */
  public static long intersectionCount(OldFixedBitSet a, OldFixedBitSet b) {
    // Depends on the ghost bits being clear!
   ...
   * set is modified.
   */
  public static long unionCount(OldFixedBitSet a, OldFixedBitSet b) {
    // Depends on the ghost bits being clear!
   ...
   */
  public static long andNotCount(OldFixedBitSet a, OldFixedBitSet b) {
    // Depends on the ghost bits being clear!
   ...
   */
  public OldFixedBitSet(int numBits) {
   ...
   */
  public OldFixedBitSet(long[] storedBits, int numBits) {
  ...
  // TODO: This does not compile with the hacked OldFixedBitSet class
/*  @Override
  public void or(DocIdSetIterator iter) throws IOException {
    if (BitSetIterator.getFixedBitSetOrNull(iter) != null) {
      assertUnpositioned(iter);
      final OldFixedBitSet bits = BitSetIterator.getFixedBitSetOrNull(iter);
      or(bits);
    } else {
      super.or(iter);
    }
  ...
  /** this = this OR other */
  public void or(OldFixedBitSet other) {
  ...
  /** this = this XOR other */
  public void xor(OldFixedBitSet other) {
...
/*  public void xor(DocIdSetIterator iter) throws IOException {
  ...
  public boolean intersects(OldFixedBitSet other) {
    // Depends on the ghost bits being clear!
  ...
  /** this = this AND other */
  public void and(OldFixedBitSet other) {
  ...
  public void andNot(OldFixedBitSet other) {
  ...
  @Override
  public OldFixedBitSet clone() {
    long[] bits = new long[this.bits.length];
    System.arraycopy(this.bits, 0, bits, 0, numWords);
    return new OldFixedBitSet(bits, numBits);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof OldFixedBitSet)) {
      return false;
    }
    OldFixedBitSet other = (OldFixedBitSet) o;
