...
final class IndexedDISI extends DocIdSetIterator {
  ...
  // TODO LUCENE-8585: Collect offset+rank for the blocks and either return them or write to meta
  ...
  // TODO LUCENE-8585: Add offsets+rank jump-table as argument (could be a meta-slice)
  ...
  private void advanceBlock(int targetBlock) throws IOException {
    if (targetBlock >= block+2) { // 1 block skip is (slightly) faster to do without block jump table
      // TODO LUCENE-8585: Access the offset from the persistent jump-tables
/*      
