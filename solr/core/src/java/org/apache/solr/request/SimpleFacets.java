...
public class SimpleFacets {
  ...
  protected void parseParams(String type, String param) throws SyntaxError, IOException {
    ...
    if (tagMap != null && rb != null) {
      ...
      if (rb.grouping() && rb.getGroupingSpec().isTruncateGroups()) {
        ...
        grouping.setOptimizeScoreCollecting(rb.getGroupingSpec().isOptimizeScoreCollecting());
   ...
   */
  private NamedList<Integer> getTermCounts(String field, Integer mincount, DocSet base, String termList) throws IOException {
