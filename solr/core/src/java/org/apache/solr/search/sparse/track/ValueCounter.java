...
public interface ValueCounter {
  ...
  /**
   * @return an empty ValueCounter with a setup defined by the template, ready for use.
   */
  // TODO: Move this to another interface to de-couple ValueCounter factories from instances
